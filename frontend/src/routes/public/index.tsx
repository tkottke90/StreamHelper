...
const PublicPage = () => {
  return(
    <Fragment>
      <main className="w-full h-full p-4 bg-slate-100 relative flex justify-center items-center">
        ...
        <div className="drawer z-50 flex flex-col justify-center items-center gap-2 gradient">
          <h1>Stream Helper</h1>
